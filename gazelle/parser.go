...
func (p *scalaParser) parseSingle(pyFilename string) (*treeset.Set, error) {
...
func (p *scalaParser) parse(pyFilenames *treeset.Set) (*treeset.Set, error) {
	parserMutex.Lock()
...
func moduleComparator(a, b interface{}) int {
	fmt.Fprintf(os.Stdout, "module comparator: %v || %v\n", a, b)
	fmt.Fprintf(os.Stdout, "module comparator cast : %v || %v\n", a.(module).Name, b.(module).Name)
